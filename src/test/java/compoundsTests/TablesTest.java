...
import compounds.compoundsPageObjects.CompoundsTablesPageObjects;
...
public class TablesTest extends BaseClass {
    ...
    private final String url = "http://localhost:8000/src/main/java/compounds/fixtures/tables.html";
    private final String absTablesJSFilePath = new File("compounds/jsfiles/tables/tables.js").getAbsolutePath();
    private final String tablesJSFilePath = constructPath(absTablesJSFilePath);
    private final String absTempJSFilePath = new File("compounds/jsfiles/tables/temp.js").getAbsolutePath();
    ...
    CompoundsTablesPageObjects compTablesPgObj = null;

    @BeforeClass(alwaysRun = true)
    private void beforeClass() {
        compTablesPgObj = new CompoundsTablesPageObjects();

...
public class ButtonsTest extends BaseClass {
    ...
    public Object[][] getAppendValidClassNames() {
        return new Object[][]{
                {"btnType: '',", "btnSize: 'large',", "children: 'default-large',", "pe-btn--btn_large", new String[]{commonUtils.hex2Rgb("#D9D9D9"), commonUtils.hex2RgbWithoutTransparency("#D9D9D9")}, new String[]{"36px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: 'primary',", "btnSize: 'xlarge',", "children: 'primary-xlarge',", "pe-btn__primary--btn_xlarge", new String[]{commonUtils.hex2Rgb("#047A9C"), commonUtils.hex2RgbWithoutTransparency("#047A9C")}, new String[]{"44px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: 'cta',", "btnSize: 'small',", "children: 'cta-small',", "pe-btn__cta--btn_small", new String[]{commonUtils.hex2Rgb("#FFB81C"), commonUtils.hex2RgbWithoutTransparency("#FFB81C")}, new String[]{"28px"}, new String[]{"14px"}, new String[]{"18px"}}
        };
    }
    ...
    public Object[][] getButtonPropTypesTestData() {
        return new Object[][]{
                {"btnType: '',", "btnSize: 'large',", "children: 'default-large',", "pe-btn--btn_large", new String[]{commonUtils.hex2Rgb("#D9D9D9"), commonUtils.hex2RgbWithoutTransparency("#D9D9D9")}, new String[]{"36px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: '',", "btnSize: 'xlarge',", "children: 'default-xlarge',", "pe-btn--btn_xlarge", new String[]{commonUtils.hex2Rgb("#D9D9D9"), commonUtils.hex2RgbWithoutTransparency("#D9D9D9")}, new String[]{"44px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: '',", "btnSize: 'small',", "children: 'default-small',", "pe-btn--btn_small", new String[]{commonUtils.hex2Rgb("#D9D9D9"), commonUtils.hex2RgbWithoutTransparency("#D9D9D9")}, new String[]{"28px"}, new String[]{"14px"}, new String[]{"18px"}},
                ...
                {"btnType: 'primary',", "btnSize: 'large',", "children: 'primary-large',", "pe-btn__primary--btn_large", new String[]{commonUtils.hex2Rgb("#047A9C"), commonUtils.hex2RgbWithoutTransparency("#047A9C")}, new String[]{"36px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: 'primary',", "btnSize: 'xlarge',", "children: 'primary-xlarge',", "pe-btn__primary--btn_xlarge", new String[]{commonUtils.hex2Rgb("#047A9C"), commonUtils.hex2RgbWithoutTransparency("#047A9C")}, new String[]{"44px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: 'primary',", "btnSize: 'small',", "children: 'primary-small',", "pe-btn__primary--btn_small", new String[]{commonUtils.hex2Rgb("#047A9C"), commonUtils.hex2RgbWithoutTransparency("#047A9C")}, new String[]{"28px"}, new String[]{"14px"}, new String[]{"18px"}},
                ...
                {"btnType: 'cta',", "btnSize: 'large',", "children: 'cta-large',", "pe-btn__cta--btn_large", new String[]{commonUtils.hex2Rgb("#FFB81C"), commonUtils.hex2RgbWithoutTransparency("#FFB81C")}, new String[]{"36px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: 'cta',", "btnSize: 'xlarge',", "children: 'cta-xlarge',", "pe-btn__cta--btn_xlarge", new String[]{commonUtils.hex2Rgb("#FFB81C"), commonUtils.hex2RgbWithoutTransparency("#FFB81C")}, new String[]{"44px"}, new String[]{"16px"}, new String[]{"20px"}},
                {"btnType: 'cta',", "btnSize: 'small',", "children: 'cta-small',", "pe-btn__cta--btn_small", new String[]{commonUtils.hex2Rgb("#FFB81C"), commonUtils.hex2RgbWithoutTransparency("#FFB81C")}, new String[]{"28px"}, new String[]{"14px"}, new String[]{"18px"}},

...
public class AlertsTest extends BaseClass {
    private final String alertsUrl = "http://localhost:8000/src/main/java/compounds/fixtures/alerts.html";
    private final String absAlertsJSFilePath = new File("compounds/jsfiles/alerts/alerts.js").getAbsolutePath();
    private final String alertsJSFilePath = constructPath(absAlertsJSFilePath);
    private final String absTempJSFilePath = new File("compounds/jsfiles/alerts/temp.js").getAbsolutePath();

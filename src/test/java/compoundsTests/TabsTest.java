...
public class TabsTest extends BaseClass {
    private final String url = "http://localhost:8000/src/main/java/compounds/fixtures/tabs.html";
    private final String absTabsJSFilePath = new File("compounds/jsfiles/tabs/tabs.js").getAbsolutePath();

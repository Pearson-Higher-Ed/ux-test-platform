...
public class FooterTest extends BaseClass {
    private final String url = "http://localhost:8000/src/main/java/compounds/fixtures/footer.html";
    private final String absFooterJSFilePath = new File("compounds/jsfiles/footer/footer.js").getAbsolutePath();
    private final String footerJSFilePath = constructPath(absFooterJSFilePath);
    private final String absTempJSFilePath = new File("compounds/jsfiles/footer/temp.js").getAbsolutePath();

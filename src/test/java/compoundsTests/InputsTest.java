...
public class InputsTest extends BaseClass {
    ...
    public Object[][] getNegativeConfigTestData() {
        return new Object[][]{
                {"empty-elementId-textinput", new String[]{"componentName", "TextInput"}, new String[]{"id", "sl-text-input", "labelText", "Last Name", "inputType", "default", "fancy", "true", "placeholder", "Last Name"}, "Target container is not a DOM element"},
                {"empty-elementId-passwordinput", new String[]{"componentName", "TextInput"}, new String[]{"password", "true", "fancy", "true", "id", "password-input-fancy", "labelText", "Password", "inputState", "default", "placeholder", "Password", "showText", "show", "hideText", "hide", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "Target container is not a DOM element"},
                {"empty-elementId-selectinput", new String[]{"componentName", "Select"}, new String[]{"id", "select-input-fancy", "labelText", "Select Label", "options", "['ipad', 'mac','iphone']", "fancy", "true", "inputState", "default", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "Target container is not a DOM element"},
                {"empty-elementId-multiline", new String[]{"componentName", "MultiLineText"}, new String[]{"id", "multiLine-text-input", "labelText", "Multi-line label", "inputState", "default", "placeholder", "Multilinetext placeholder"}, "Target container is not a DOM element"},
                {"empty-elementId-checkbox", new String[]{"componentName", "RadioCheckGroup"}, new String[]{"id", "checkboxInput", "inputType", "checkbox", "legendText", "checkbox1", "options", "{'checked':'default', 'uncheckedDisabled' : 'disabled', 'Unchecked':'','checkedDisabled':'disabled'}", "selectedOptions", "['checked, 'checkedDisabled']"}, "Target container is not a DOM element"},
                {"empty-elementId-radio", new String[]{"componentName", "RadioCheckGroup"}, new String[]{"id", "unselected", "inputType", "radio", "legendText", "radio1", "options", "{'selected':' 'default', 'unselectedDisabled':'', 'unselected':'','selectedDisabled':''}", "selectedOptions", "['']"}, "Target container is not a DOM element"},

                {"incorrect-elementId-textinput", new String[]{"elementId", "text-input-target1", "componentName", "TextInput"}, new String[]{"id", "sl-text-input", "labelText", "Last Name", "inputType", "default", "fancy", "false", "placeholder", "Last Name"}, "Target container is not a DOM element"},
                {"incorrect-elementId-passwordinput", new String[]{"elementId", "password-input-target1", "componentName", "TextInput"}, new String[]{"password", "true", "fancy", "true", "id", "password-input-fancy", "labelText", "Password", "inputState", "default", "placeholder", "Password", "showText", "show", "hideText", "hide", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "Target container is not a DOM element"},
                {"incorrect-elementId-selectinput", new String[]{"elementId", "select-target1", "componentName", "Select"}, new String[]{"id", "select-input-fancy", "labelText", "Select Label", "options", "['ipad', 'mac','iphone']", "fancy", "true", "inputState", "default", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "Target container is not a DOM element"},
                {"incorrect-elementId-multiline", new String[]{"elementId", "multilinetext-target1", "componentName", "MultiLineText"}, new String[]{"id", "multiLine-text-input", "labelText", "Multi-line label", "inputState", "default", "placeholder", "Multilinetext placeholder"}, "Target container is not a DOM element"},
                {"incorrect-elementId-checkbox", new String[]{"elementId", "checkbox-target1", "componentName", "RadioCheckGroup"}, new String[]{"id", "checkboxInput", "inputType", "checkbox", "legendText", "checkbox1", "options", "{'checked':'default', 'uncheckedDisabled' : 'disabled', 'Unchecked':'','checkedDisabled':'disabled'}", "selectedOptions", "['checked, 'checkedDisabled']"}, "Target container is not a DOM element"},
                {"incorrect-elementId-radio", new String[]{"elementId", "radio-target1", "componentName", "RadioCheckGroup"}, new String[]{"id", "unselected", "inputType", "radio", "legendText", "radio1", "options", "{'selected':' 'default', 'unselectedDisabled':'', 'unselected':'','selectedDisabled':''}", "selectedOptions", "['']"}, "Target container is not a DOM element"},

                {"empty-componentName-textinput", new String[]{"elementId", "text-input-target"}, new String[]{"id", "sl-text-input", "labelText", "Last Name", "inputType", "default", "fancy", "true", "placeholder", "Last Name"}, "type is invalid"},
                {"empty-componentName-passwordinput", new String[]{"elementId", "password-input-target"}, new String[]{"password", "true", "fancy", "true", "id", "password-input-fancy", "labelText", "Password", "inputState", "default", "placeholder", "Password", "showText", "show", "hideText", "hide", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "type is invalid"},
                {"empty-componentName-selectinput", new String[]{"elementId", "select-target"}, new String[]{"id", "select-input-fancy", "labelText", "Select Label", "options", "['ipad', 'mac','iphone']", "fancy", "true", "inputState", "default", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "type is invalid"},
                {"empty-componentName-multiline", new String[]{"elementId", "multilinetext-target"}, new String[]{"id", "multiLine-text-input", "labelText", "Multi-line label", "inputState", "default", "placeholder", "Multilinetext placeholder"}, "type is invalid"},
                {"empty-componentName-checkbox", new String[]{"elementId", "checkbox-target"}, new String[]{"id", "checkboxInput", "inputType", "checkbox", "legendText", "checkbox1", "options", "{'checked':'default', 'uncheckedDisabled' : 'disabled', 'Unchecked':'','checkedDisabled':'disabled'}", "selectedOptions", "['checked, 'checkedDisabled']"}, "type is invalid"},
                {"empty-componentName-radio", new String[]{"elementId", "radio-target"}, new String[]{"id", "unselected", "inputType", "radio", "legendText", "radio1", "options", "{'selected':' 'default', 'unselectedDisabled':'', 'unselected':'','selectedDisabled':''}", "selectedOptions", "['']"}, "type is invalid"},

                {"incorrect-componentName-textinput", new String[]{"elementId", "text-input-target", "componentName", "TextInput1"}, new String[]{"id", "sl-text-input", "labelText", "Last Name", "inputType", "default", "fancy", "false", "placeholder", "Last Name"}, "type is invalid"},
                ...
                {"incorrect-componentName-selectinput", new String[]{"elementId", "select-target", "componentName", "Select1"}, new String[]{"id", "select-input-fancy", "labelText", "Select Label", "options", "['ipad', 'mac','iphone']", "fancy", "true", "inputState", "default", "infoMessage", "This is an info message", "errorMessage", "This is an error message"}, "type is invalid"},
                {"incorrect-componentName-multiline", new String[]{"elementId", "multilinetext-target", "componentName", "MultiLineText1"}, new String[]{"id", "multiLine-text-input", "labelText", "Multi-line label", "inputState", "default", "placeholder", "Multilinetext placeholder"}, "type is invalid"},
                {"incorrect-componentName-checkbox", new String[]{"elementId", "checkbox-target", "componentName", "RadioCheckGroup1"}, new String[]{"id", "checkboxInput", "inputType", "checkbox", "legendText", "checkbox1", "options", "{'checked':'default', 'uncheckedDisabled' : 'disabled', 'Unchecked':'','checkedDisabled':'disabled'}", "selectedOptions", "['checked, 'checkedDisabled']"}, "type is invalid"},
                {"incorrect-componentName-radio", new String[]{"elementId", "radio-target", "componentName", "RadioCheckGroup1"}, new String[]{"id", "unselected", "inputType", "radio", "legendText", "radio1", "options", "{'selected':' 'default', 'unselectedDisabled':'', 'unselected':'','selectedDisabled':''}", "selectedOptions", "['']"}, "type is invalid"}
        };

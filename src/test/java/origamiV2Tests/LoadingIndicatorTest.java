...
import origamiV2.origamiV2PageObjects.LoadingIndicatorPageObjects;
...
public class LoadingIndicatorTest extends BaseClass {
    private final String url = "http://localhost:8000/src/main/java/origamiV2/fixtures/loadingIndicator/loadingIndicator.html";
    private final String absLoadingIndJSFilePath = new File("origamiV2/jsfiles/loadingIndicator/loadingIndicator.js").getAbsolutePath();
    private final String loadingIndicatorJSFilePath = constructPath(absLoadingIndJSFilePath);
    private final String absTempJSFilePath = new File("origamiV2/jsfiles/loadingIndicator/temp.js").getAbsolutePath();
    ...
    final static Logger log = Logger.getLogger(origamiV2Tests.LoadingIndicatorTest.class.getName());

...
public class CalendarTest extends BaseClass {
    ...
    private final String absTempJSFilePath = new File("elementsSDK/functional/jsfiles/calendar/temp.js").getAbsolutePath();
    ...
    @Test(testName = "Current Date Test", dataProvider = "Current Date Test Data", groups = {"desktop-regression", "desktop-ci", "mobile-regression"})
    ...
    @Test(testName = "Disabled Date Test", dataProvider = "Disabled Date Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    //calendar container
    @Test(testName = "Calendar Container Test", dataProvider = "Calendar Container Test Data", groups = {"desktop-regression", "desktop-ci", "mobile-regression"})
    ...
    //month
    @Test(testName = "Inner Calendar Test", dataProvider = "Month Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    //days of week
    @Test(testName = "Days of Week Test", dataProvider = "DaysOfWeek Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    @Test(testName = "Disable Past Prop Test", dataProvider = "Disable Past Test Data", groups = {"desktop-regression", "mobile-regression"}, retryAnalyzer = RetryAnalyzer.class)
    ...
    @Test(testName = "Day Names Prop Test", dataProvider = "Day Names Prop Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    @Test(testName = "Translated Month Names Full Test", dataProvider = "Translated Month Names Full Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    @Test(testName = "Secondary Date Test", dataProvider = "Secondary Date Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    @Test(testName = "Min Date Test", dataProvider = "Min Date Test Data", groups = {"desktop-regression", "mobile-regression"})
    ...
    @Test(testName = "A Valid Date Test", dataProvider = "A Valid Date Test Data", groups = {"desktop-regression", "desktop-ci", "mobile-regression"})

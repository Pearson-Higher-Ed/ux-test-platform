...
import elementsSDK.functional.functionalPageObjects.FunctionalIconsPageObjects;
...
public class IconsTest extends BaseClass {
    ...
    FunctionalIconsPageObjects compIconsPgObj = null;

    @BeforeClass(alwaysRun = true)
    private void IconsTestBeforeClass() {
        compIconsPgObj = new FunctionalIconsPageObjects();

...
import standAlone.standAlonePageObjects.ModalPageObjects;
...
public class ModalTest extends BaseClass {
    ...
    private Object[][] getModalWidthAndOverlayTestData() {
        return new Object[][]{
                ...
                {"sm", 480, 300, "false", modalPgObj.modalWithoutFooterTemplateReact, new String[]{"440px"}, new String[]{"106px", "123.984px"}, new String[]{commonUtils.hex2Rgb("#FFFFFF"), commonUtils.hex2RgbWithoutTransparency("#FFFFFF")}, new String[]{"2px", "2px", "2px", "2px"}, "iPhone 6s Plus", ScreenOrientation.LANDSCAPE},
                {"xs", 320, 300, "false", modalPgObj.modalWithoutFooterTemplateReact, new String[]{"360px", "374px", "335px", "414px", "320px"}, new String[]{"106px", "123.984px"}, new String[]{commonUtils.hex2Rgb("#FFFFFF"), commonUtils.hex2RgbWithoutTransparency("#FFFFFF")}, new String[]{"2px", "2px", "2px", "2px"}, "iPhone 6s Plus", ScreenOrientation.PORTRAIT}
        };
    }
    ...
    private void negativeConfigValuesTest(String errorType, String[] detailsPropertiesList, String[]
        ...
        if (((browser.equals("firefox")) || (browser.equals("safari")) || (browser.equals("ie")) || browser.equals("edge") || (lBrowser.equals("firefox")))) {
            throw new SkipException("standAlone-> Focus operation not yet supported in firefox/safari/ie browser drivers");
        }
        setConfigAndLaunch(detailsPropertiesList, propsTextList, propsPropertiesList);

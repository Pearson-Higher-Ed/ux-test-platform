...
public class TypographyTest extends BaseClass {
	...
	private Object[][] getBodyTestData() {
		return new Object[][] { 
			{ typoPgObj.paragraph1, "16px", "22px", "rgba(35, 31, 32, 1)"} 
		};
	}

	// Test 1
	@Test(testName = "Body Test", dataProvider = "getBodyTestData", groups = {"desktop"})
	private void bodyTest(By element, String fontsize, String lineheight, String color){
		chooseEnv();
	...
	private Boolean verifyBodyFont(By bodyElement, String fontsize, String lineheight, String color, String mobile) {
		// get FontSize

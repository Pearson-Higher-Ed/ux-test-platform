...
public class TypographyTest extends BaseClass {
	...
	private void HeadingsTestBeforeClass(String runEnv, String mobile,
	...
	private Object[][] getBodyTestData() {
		return new Object[][] { { typoPgObj.paragraph1, "16px", "22px",
				"rgba(35, 31, 32, 1)" }, };
	}

	// Test 1
	@Test(testName = "Body Test", dataProvider = "getBodyTestData", groups = { "desktop" })
	private void bodyTest(By element, String fontsize, String lineheight,
	...
	private Object[][] getListsFontTestData() {
		return new Object[][] {
				// ordered
				{ typoPgObj.orderedListItem1, "16px", "22px",
						"rgba(35, 31, 32, 1)" },
				{ typoPgObj.orderedListChildItem1, "16px", "22px",
						"rgba(35, 31, 32, 1)" },
				{ typoPgObj.orderedListGrandChildItem1, "16px", "22px",
						"rgba(35, 31, 32, 1)" },
				// Unordered
				{ typoPgObj.unorderedListItem1, "16px", "22px",
						"rgba(35, 31, 32, 1)" },
				{ typoPgObj.unorderedListChildItem1, "16px", "22px",
						"rgba(35, 31, 32, 1)" },
				{ typoPgObj.unorderedListGrandChildItem1, "16px", "22px",
						"rgba(35, 31, 32, 1)" }, };
	}

	// Test 2
	@Test(testName = "Lists font fest", dataProvider = "getListsFontTestData", groups = { "desktop" })
	private void ListsFontTest(By element, String fontsize, String lineheight,
			String color) {
		chooseEnv();
	...
	private void ListItemSpacingTest(By element, String space_list_items) {
		...
		int int_actualFontSize = Integer.parseInt(actualFontSize.replace("px",
				""));
		int int_space_list_items = Integer.parseInt(space_list_items.replace(
				"px", ""));
		// Add expected line space between list item with font size
		int expectedLineHeight = int_actualFontSize + int_space_list_items;
		// Verify Line Height
		String actualListItemSpace = commonUtils.getCSSValue(element,
				"line-height");

		boolean result_1 = commonUtils.assertValue(actualListItemSpace,
				expectedLineHeight + "px", "Lists line-height specification Failed");
	}
	...
	private void ListItemLeftPaddingTest(By element, String leftPadding) {
		chooseEnv();
		// Verify left padding
		String actualPaddingLeft = commonUtils.getCSSValue(element,
				"padding-left");

		boolean result_1 = commonUtils.assertValue(actualPaddingLeft,
				leftPadding, "Lists padding-left specification Failed");
	}
	...
	private void ListsMarginAfterHeaderTest(By element, String space_above) {
		chooseEnv();		
		String actualSpaceAbove = commonUtils
				.getCSSValue(element, "margin-top");

		boolean result_1 = commonUtils.assertValue(actualSpaceAbove,
				space_above, "Lists margin-top after header specification Failed");
	}
	...
	private Object[][] getHeadingsTestData() {
		return new Object[][] {
				{ typoPgObj.heading_one, "24px", "30px", "bold",
						"rgba(35, 31, 32, 1)", "h1" },
				{ typoPgObj.heading_two, "20px", "24px", "bold",
						"rgba(35, 31, 32, 1)", "h2" },
				{ typoPgObj.heading_three, "18px", "22px", "bold",
						"rgba(35, 31, 32, 1)", "h3" },
				{ typoPgObj.heading_four, "16px", "20px", "bold",
						"rgba(86, 86, 86, 1)", "h4" },
				{ typoPgObj.heading_five, "16px", "20px", "bold",
						"rgba(86, 86, 86, 1)", "h5" },
				{ typoPgObj.heading_six, "14px", "16px", "bold",
						"rgba(86, 86, 86, 1)", "h6" } };
	}

	@Test(enabled = true, testName = "Heading Test", dataProvider = "getHeadingsCSSTestData", groups = { "desktop" })
	private void HeadingCSSTest(By element, String fontSize, String lineHeight,
			String fontWeight, String fontColor, String item)
			throws InterruptedException, UnsupportedEncodingException {
		chooseEnv();
		result = HeadingCSSEval(element, fontSize, lineHeight, fontWeight,
				fontColor, item);
		Assert.assertTrue(result);
	}
	...
	private Object[][] getHeadingsMrgnTestData() {
		return new Object[][] { { typoPgObj.heading_two_two, },
	...
	private void HeadingMrgnTest(By element) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();

		String margin = commonUtils.getCSSValue(element, "margin-top");
		commonUtils.assertValue(margin, "40px",
				"Header that follows a header has a 6px margin");
	}

	@DataProvider(name = "getHeadingsMrgnCntntTestData")
	private Object[][] getHeadingsMrgnCntntTestData() {

		return new Object[][] {{ typoPgObj.heading_oneOne,"20px",}, { typoPgObj.heading_twoTwo,"20px", },
				{ typoPgObj.heading_threeThree,"20px", }, { typoPgObj.heading_fourFour, "20px",},
				{ typoPgObj.heading_fiveFive,"20px", },{ typoPgObj.heading_sixSix,"20px", },   
		};
	}


	@Test(enabled = true, testName = "Heading Margin Content Test", dataProvider = "getHeadingsMrgnCntntTestData",groups = { "desktop" })
	private void HeadingMrgnParaTest(By element,String actulmrgn) throws InterruptedException,UnsupportedEncodingException {
		chooseEnv();
		String  margin = commonUtils.getCSSValue(element, "margin-top");
	...
	private Object[][] getcodeTestData() {
		return new Object[][] {{ "'Lucida Sans Typewriter', 'Lucida Console', monaco, 'Bitstream Vera Sans Mono', monospace",
			"14px","20px","rgba(66, 66, 66, 1)","rgba(174, 174, 174, 1)", },    
		};
	}
	@Test(enabled = true,  dataProvider = "getCodeTestData",testName = "Code Test", groups = { "desktop" })
	private void CodeTest(String fntFamly,String fntSize,String lnHeight,String bckClr,String fntColr) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();

		String fontFamily = commonUtils.getCSSValue(typoPgObj.code,
				"font-family");
		String fontSize = commonUtils.getCSSValue(typoPgObj.code, "font-size");
		String lneHeight = commonUtils.getCSSValue(typoPgObj.code,
				"line-height");
		String bckgrnd = commonUtils.getCSSValue(typoPgObj.code,
				"background-color");
		String fntClr = commonUtils.getCSSValue(typoPgObj.code, "color");

		commonUtils.assertValue(fontFamily,fntFamly,
				"Font Family is not "+fontFamily);
		...
		commonUtils.assertValue(bckgrnd, bckClr,
				"Background Color is not "+bckClr);
	...
	private Object[][] getInlnCodeTestData() {
		return new Object[][] {{ "'Lucida Sans Typewriter', 'Lucida Console', monaco, 'Bitstream Vera Sans Mono', monospace",
			"4px","4px","rgba(230, 230, 230, 1)",},    
		};
	}
	
	@Test(enabled = true, testName = "Inline Code Test",dataProvider = "getInlnCodeTestData", groups = { "desktop" })
	private void InlneCodeTest(String fntFamly,String pddngLft,String pddngRgt,String bckClr) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();

		String fontFamily = commonUtils.getCSSValue(typoPgObj.inlne_code,
				"font-family");
		String pdngLft = commonUtils.getCSSValue(typoPgObj.inlne_code,
				"padding-left");
		String pdngRght = commonUtils.getCSSValue(typoPgObj.inlne_code,
				"padding-right");
		String bckgrnd = commonUtils.getCSSValue(typoPgObj.inlne_code, "background-color");
		

		commonUtils.assertValue(fontFamily, fntFamly,
				"Font Family is not"+fntFamly);
	...
	private void kbdTest(String fntFamly,String pddngLft,String pddngRgt,String bckClr) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();
	...
	private Object[][] MobileBodyTestData() {
		return new Object[][] {
				{ ScreenOrientation.PORTRAIT, typoPgObj.paragraph1, "16px",
						"22px", "rgba(35, 31, 32, 1)" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.paragraph1, "16px",
						"22px", "rgba(35, 31, 32, 1)" }, };
	}

	// Test 1
	@Test(testName = "Mobile Test for Body", dataProvider = "MobileBodyTestData", groups = { "mobile" }, enabled = true)
	private void MobileBodyTest(ScreenOrientation mode, By element,
			String fontsize, String lineheight, String color) {
		appium.rotate(mode);
		commonUtils.getUrl(url, "mobile");
		result = verifyBodyFont(element, fontsize, lineheight, color, "mobile");
		Assert.assertTrue(result);
	}
	...
	private void OrderedListsFontTestMobile(ScreenOrientation mode, By element,
			String fontsize, String lineheight, String color) {
		appium.rotate(mode);
		commonUtils.getUrl(url, "mobile");
		result = verifyListItemFont(element, fontsize, lineheight, color,
	...
	private Object[][] getListItemsTestDataMobile() {
		return new Object[][] {
				...
				{ ScreenOrientation.PORTRAIT,
						typoPgObj.orderedListGrandChildItem1 },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.orderedListItem1 },
	...
	private void ListItemSpacingTestMobile(By element) {
		...
		String actualListItemSpace = commonUtils.getCSSValue(element,
				"line-height", "mobile");
		boolean result_1 = commonUtils.assertValue(actualListItemSpace,
				expectedLineHeight + "px", "Lists item line-height specification Failed");
	}
	...
	private Object[][] getListItemsLeftPaddingTestDataMobile() {
		return new Object[][] {
				...
				{ ScreenOrientation.PORTRAIT, typoPgObj.orderedListLevel1,
						"26px" },
				{ ScreenOrientation.PORTRAIT, typoPgObj.orderedListLevel2,
						"20px" },
				{ ScreenOrientation.PORTRAIT, typoPgObj.orderedListLevel3,
						"20px" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.orderedListLevel1,
						"26px" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.orderedListLevel2,
						"20px" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.orderedListLevel3,
						"20px" },
				// Unordered
				{ ScreenOrientation.PORTRAIT, typoPgObj.unorderedListLevel1,
						"26px" },
				{ ScreenOrientation.PORTRAIT, typoPgObj.unorderedListLevel2,
						"20px" },
				{ ScreenOrientation.PORTRAIT, typoPgObj.unorderedListLevel3,
						"20px" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.unorderedListLevel1,
						"26px" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.unorderedListLevel2,
						"20px" },
				{ ScreenOrientation.LANDSCAPE, typoPgObj.unorderedListLevel3,
						"20px" }, };
	}

	// Test 5
	@Test(testName = "Lists left padding Mobile", dataProvider = "getListItemsLeftPaddingTestDataMobile", groups = { "mobile" })
	private void getListItemsLeftPaddingTestDataMobile(By element,
			String leftPadding) {
		chooseEnv();
		// Verify left padding
		String actualPaddingLeft = commonUtils.getCSSValue(element,
	...
	private void ListsMarginAfterHeaderTestMobile(By element, String space_above) {
		chooseEnv();
		String actualSpaceAbove = commonUtils.getCSSValue(element,
				"margin-top", "mobile");
	...
	private void HeadingMobileTestLANDSCAPE(By element, String fontSize,
			String lineHeight, String fontWeight, String fontColor, String item)
			throws InterruptedException, UnsupportedEncodingException {
		chooseEnv();
		result = HeadingCSSEvalMob(element, fontSize, lineHeight, fontWeight,
				fontColor, item, ScreenOrientation.LANDSCAPE);
		Assert.assertTrue(result);
	...
	private void HeadingMrgnParaMobileTest(By element,String actulmrgn) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();
		appium.rotate(ScreenOrientation.LANDSCAPE);
		String  margin = commonUtils.getCSSValue(element, "margin-top");
	...
	private void HeadingMrgnCntntMobileTest(By element)
			throws InterruptedException, UnsupportedEncodingException {
		chooseEnv();
		appium.rotate(ScreenOrientation.LANDSCAPE);
		String margin = commonUtils.getCSSValue(element, "margin-top");
		commonUtils.assertValue(margin, "6px",
				"Header that follows a heading has a 6pxpx margin");
	}

	// Test For Portrait
	@Test(enabled = true, testName = "Heading Test", dataProvider = "getHeadingsCSSTestData", groups = { "mobile" })
	private void HeadingMobileTestPORTRAIT(By element, String fontSize,
			String lineHeight, String fontWeight, String fontColor, String item)
			throws InterruptedException, UnsupportedEncodingException {
		chooseEnv();
		result = HeadingCSSEvalMob(element, fontSize, lineHeight, fontWeight,
				fontColor, item, ScreenOrientation.PORTRAIT);
		Assert.assertTrue(result);
	...
	private void CodeMobileTestLANDSCAPE(String fntFamly,String fntSize,String lnHeight,String bckClr,String fntColr) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();
		appium.rotate(ScreenOrientation.LANDSCAPE);
		String fontFamily = commonUtils.getCSSValue(typoPgObj.code,
	...
	private void InlneCodeMobileTestLANDSCAPE(String fntFamly,String pddngLft,String pddngRgt,String bckClr) throws InterruptedException,
		...
		String pdngRght = commonUtils.getCSSValue(typoPgObj.inlne_code,
				"padding-right");
		String bckgrnd = commonUtils.getCSSValue(typoPgObj.inlne_code,
				"background-color");
	...
	private void kbdCodeMobileTestLANDSCAPE(String fntFamly,String pddngLft,String pddngRgt,String bckClr) throws InterruptedException,
	...
	private void HeadingMrgnParaMobileTestPORTRAIT(By element,String actulmrgn) throws InterruptedException,
			UnsupportedEncodingException {
		chooseEnv();
		appium.rotate(ScreenOrientation.PORTRAIT);
		String  margin = commonUtils.getCSSValue(element, "margin-top");
	...
	private void HeadingMrgnCntntMobileTestPORTRAIT(By element, String actlMrgn)
		...
		appium.rotate(ScreenOrientation.PORTRAIT);
		String margin = commonUtils.getCSSValue(element, "margin-top");
		commonUtils.assertValue(margin, actlMrgn,
				"Header that follows a heading  " + actlMrgn + " margin");
	}



	@Test(enabled = true, testName = "Code Test",dataProvider = "getCodeTestData", groups = { "mobile" })
	private void CodeMobileTestPORTRAIT(String fntFamly,String fntSize,String lnHeight,String bckClr,String fntColr) throws InterruptedException,
	...
	@Test(enabled = true, testName = "Inline Code Test", dataProvider = "getInlnCodeTestData",groups = { "mobile" })
	private void InlneCodeMobileTestPORTRAIT(String fntFamly,String pddngLft,String pddngRgt,String bckClr) throws InterruptedException,
	...
	@Test(enabled = true, testName = "Kbd Code Test", dataProvider = "getkbdTestData",groups = { "mobile" })
	private void kbdCodeMobileTestPORTRAIT(String fntFamly,String pddngLft,String pddngRgt,String bckClr) throws InterruptedException,
	...
	// Feature : Body
	private boolean verifyBodyFont(By bodyElement, String fontsize,
			String lineheight, String color) {
		// get FontSize
		String actualFontSize = commonUtils.getCSSValue(bodyElement,
				"font-size");
		// get LineHeight
		String actualLineHeight = commonUtils.getCSSValue(bodyElement,
				"line-height");
		// get Color
		String actualColor = commonUtils.getCSSValue(bodyElement, "color");

		boolean result_1 = commonUtils.assertValue(actualFontSize, fontsize,
				"Body Copy font-size specification Failed");
		boolean result_2 = commonUtils.assertValue(actualLineHeight,
				lineheight, "Body Copy line-height specification Failed");
		boolean result_3 = commonUtils.assertValue(actualColor, color,
				"Body Copy Color specification Failed");
	...
	private Boolean verifyBodyFont(By bodyElement, String fontsize,
			String lineheight, String color, String mobile) {

		// get FontSize
		String actualFontSize_mobile = commonUtils.getCSSValue(bodyElement,
				"font-size", "mobile");
		// get LineHeight
		String actualLineHeight_mobile = commonUtils.getCSSValue(bodyElement,
				"line-height", "mobile");
		// get Color
		String actualColor_mobile = commonUtils.getCSSValue(bodyElement,
				"color", "mobile");

		boolean result_1 = commonUtils.assertValue(actualFontSize_mobile,
				fontsize, "Body Copy font-size specification Failed");
		boolean result_2 = commonUtils.assertValue(actualLineHeight_mobile,
				lineheight, "Body Copy line-height specification Failed");
		boolean result_3 = commonUtils.assertValue(actualColor_mobile, color,
				"Body Copy Color specification Failed");
	...
	// Feature : Lists
	private boolean verifyListItemFont(By element, String fontsize,
			String lineheight, String color) {
		// get FontSize
		String actualFontSize = commonUtils.getCSSValue(element, "font-size");
		// get LineHeight
		String actualLineHeight = commonUtils.getCSSValue(element,
				"line-height");
		// get Color
		String actualColor = commonUtils.getCSSValue(element, "color");

		boolean result_1 = commonUtils.assertValue(actualFontSize, fontsize,
				"List Item font-size specification Failed");
		boolean result_2 = commonUtils.assertValue(actualLineHeight,
				lineheight, "List Item line-height specification Failed");
		boolean result_3 = commonUtils.assertValue(actualColor, color,
				"List Item Color specification Failed");
	...
	private boolean verifyListItemFont(By element, String fontsize,
		...
		String actualLineHeight = commonUtils.getCSSValue(element,
				"line-height", "mobile");
		// get Color
		String actualColor = commonUtils
				.getCSSValue(element, "color", "mobile");
	...
	private boolean verifyListSpacing(By element, String space_above_below) {
		...
		String actualSpaceAbove = commonUtils
				.getCSSValue(element, "margin-top");
		// get margin-below
		String actualSpaceBelow = commonUtils.getCSSValue(element,
				"margin-bottom");

		boolean result_1 = commonUtils.assertValue(actualSpaceAbove,
				space_above_below, "Lists margin-top specification Failed");
		boolean result_2 = commonUtils.assertValue(actualSpaceBelow,
				space_above_below, "Lists margin-bottom specification Failed");
	...
	// Feature : Heading
	private boolean HeadingCSSEval(By element, String fontSize,
			String lineHeight, String fontWeight, String fontColor, String item) {
		...
		String headingLineHeight = commonUtils.getCSSValue(element,
				"line-height");
		String headingFontWeight = commonUtils.getCSSValue(element,
				"font-weight");
		String headingFontColor = commonUtils.getCSSValue(element, "color");
		
		boolean result_fontSize = commonUtils.assertValue(headingFontSize,
				fontSize, "Font Size");
		boolean result_lineHeight = commonUtils.assertValue(headingLineHeight,
				lineHeight, "Line Height" + item);
		boolean result_fontWeight = commonUtils.assertValue(headingFontWeight,
				fontWeight, "font Weight");
		boolean result_fontColor = commonUtils.assertValue(headingFontColor,
				fontColor, "Font Color");
		if (item == "h1") {
			String headingBttmBordrClr = commonUtils.getCSSValue(element,
					"border-bottom-color");
			String headingBttmBordrSze = commonUtils.getCSSValue(element,
					"border-bottom-width");
			String headingBttmBordrStl = commonUtils.getCSSValue(element,
					"border-bottom-style");
			result_bttnBordrClr = commonUtils.assertValue(headingBttmBordrClr,
					"rgba(166, 168, 171, 1)", "border-bottom-color");
			result_bttnBordrSze = commonUtils.assertValue(headingBttmBordrSze,
					"2px", "border-bottom-color");
			result_bttnBordrStl = commonUtils.assertValue(headingBttmBordrStl,
		...
		if ((result_fontSize && result_lineHeight && result_fontWeight
				&& result_bttnBordrClr && result_bttnBordrStl
	...
	private boolean HeadingCSSEvalMob(By element, String fontSize,
			String lineHeight, String fontWeight, String fontColor,
			String item, ScreenOrientation mode) {

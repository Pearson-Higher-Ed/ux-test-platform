...
public class MeterTest extends BaseClass {
    ...
    private Object[][] getMeterTestData() {
        return new Object[][]{
                {"progressbar", meterPgObj.meter, new String[]{"20px", "18px"}, new String[]{commonUtils.hex2Rgb("#e6e6e6"), commonUtils.hex2RgbWithoutTransparency("#e6e6e6")}},
                {"progerssbar-inner", meterPgObj.meterInner, new String[]{"18px"}, new String[]{commonUtils.hex2Rgb("#094877"), commonUtils.hex2RgbWithoutTransparency("#094877")}}
        };
    }

    @Test(testName = "Height and Color Test", dataProvider = "Meter Test Data", groups = {"desktop-regression"})
    private void meterTest(String state, By element, String[] expHeight, String[] expBackgroundColor) throws Exception {
        chooseEnv();
    ...
    @Test(testName = "Mobile: Height and Color Test", dataProvider = "Meter Test Data", groups = {"mobile-regression1"})
    private void meterMobileTest(String state, By element, String[] expHeight, String[] expBackgroundColor) throws Exception {
    ...
    @Test(testName = "Mobile: Border Properties Test", dataProvider = "Meter Border Properties Test Data", groups = {"mobile-regression1"})
    ...
    @Test(testName = "Mobile: Meter-Basic Label Test", groups = "mobile-regression1")

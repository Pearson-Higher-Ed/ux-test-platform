...
public class ContextualHelpPageObjects {
    ...
    public By contextualHelpDrawerHelpTopicDetailCloseButton = By.xpath("//*[@id='o-contextual-help-drawer']/div[2]/div[1]/button[1]");
    ...
    public By helpTopicLayout = By.xpath("//div[@class='o-contextual-help__topics']");
    ...
    public String xpathForHelpTopicExcerptPara(String item, int x) {
    ...
    public By testAccordionContentLink = By.id("testAccordianContent");
